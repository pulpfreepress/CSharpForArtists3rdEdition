/********************************************************************************
  Copyright 2014 Rick Miller and Pulp Free Press - All Rights Reserved 
...
public class ComparerSortDemo {
	public static void Main(){
		...
		surrealists.Sort(new PersonVOComparer());
		Console.WriteLine("---------------------------------------");
